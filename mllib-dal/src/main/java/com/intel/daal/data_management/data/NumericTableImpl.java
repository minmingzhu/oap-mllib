 ...
 * @brief Contains classes for a data management component responsible for representation of data in
 *        the numeric format
 * @ingroup data_management @{
 */
/**
 * @brief Contains classes that implement the data management component responsible for
 *        representaion of the data in numerical format
 */
...
public abstract class NumericTableImpl extends SerializableBase {
  ...
  public long getNumberOfColumns() {
    ...
    } else if (serializedCObject != null) {
  ...
  /**
   * Checks if dataset stored in the numeric table is normalized, according to the given
   * normalization flag
  ...
  DoubleBuffer getDoubleFeature(long featureIndex, long vectorIndex, long vectorNum, ByteBuffer buf)
    ...
    buf.order(ByteOrder.LITTLE_ENDIAN);
    DoubleBuffer dBuf =
        getBlockOfColumnValues(featureIndex, vectorIndex, vectorNum, buf.asDoubleBuffer());
    return dBuf;
  }
  ...
  FloatBuffer getFloatFeature(long featureIndex, long vectorIndex, long vectorNum, ByteBuffer buf)
    ...
    buf.order(ByteOrder.LITTLE_ENDIAN);
    FloatBuffer sBuf =
        getBlockOfColumnValues(featureIndex, vectorIndex, vectorNum, buf.asFloatBuffer());
    return sBuf;
  }
  ...
  IntBuffer getIntFeature(long featureIndex, long vectorIndex, long vectorNum, ByteBuffer buf)
    ...
    buf.order(ByteOrder.LITTLE_ENDIAN);
    IntBuffer iBuf =
        getBlockOfColumnValues(featureIndex, vectorIndex, vectorNum, buf.asIntBuffer());
    return iBuf;
  }
  ...
  public abstract DoubleBuffer getBlockOfRows(long vectorIndex, long vectorNum, DoubleBuffer buf)
      throws IllegalAccessException;

  public abstract FloatBuffer getBlockOfRows(long vectorIndex, long vectorNum, FloatBuffer buf)
      throws IllegalAccessException;

  public abstract IntBuffer getBlockOfRows(long vectorIndex, long vectorNum, IntBuffer buf)
      throws IllegalAccessException;

  public abstract void releaseBlockOfRows(long vectorIndex, long vectorNum, DoubleBuffer buf)
      throws IllegalAccessException;

  public abstract void releaseBlockOfRows(long vectorIndex, long vectorNum, FloatBuffer buf)
      throws IllegalAccessException;

  public abstract void releaseBlockOfRows(long vectorIndex, long vectorNum, IntBuffer buf)
      throws IllegalAccessException;

  public abstract DoubleBuffer getBlockOfColumnValues(long featureIndex, long vectorIndex,
      long vectorNum, DoubleBuffer buf) throws IllegalAccessException;

  public abstract FloatBuffer getBlockOfColumnValues(long featureIndex, long vectorIndex,
      long vectorNum, FloatBuffer buf) throws IllegalAccessException;

  public abstract IntBuffer getBlockOfColumnValues(long featureIndex, long vectorIndex,
      long vectorNum, IntBuffer buf) throws IllegalAccessException;

  public abstract void releaseBlockOfColumnValues(long featureIndex, long vectorIndex,
      long vectorNum, DoubleBuffer buf) throws IllegalAccessException;
