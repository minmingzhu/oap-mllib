 ...
 * @brief Numeric table that provides methods to access data that is stored in the Compressed Sparse
 *        Row(CSR) data layout
 */
public class CSRNumericTableImpl extends NumericTableImpl {
  ...
  public DoubleBuffer getBlockOfRows(long vectorIndex, long vectorNum, DoubleBuffer buf) {
    ...
    DataFeatureUtils.VectorUpCastIface vectorUpCast =
        DataFeatureUtils.VectorUpCast.getCast(df.type, double.class);
    vectorUpCast.upCast(sparseBlockSize, (int) (rowOffsets[iVectorIndex] - 1), jData,
        sparseDataPartBuffer);
  ...
  public FloatBuffer getBlockOfRows(long vectorIndex, long vectorNum, FloatBuffer buf) {
    ...
    DataFeature df = dict.getFeature(0);
    DataFeatureUtils.VectorUpCastIface vectorUpCast =
        DataFeatureUtils.VectorUpCast.getCast(df.type, float.class);
    vectorUpCast.upCast(sparseBlockSize, (int) (rowOffsets[iVectorIndex] - 1), jData,
        sparseDataPartBuffer);
  ...
  public IntBuffer getBlockOfRows(long vectorIndex, long vectorNum, IntBuffer buf) {
    ...
    DataFeature df = dict.getFeature(0);
    DataFeatureUtils.VectorUpCastIface vectorUpCast =
        DataFeatureUtils.VectorUpCast.getCast(df.type, int.class);
    vectorUpCast.upCast(sparseBlockSize, (int) (rowOffsets[iVectorIndex] - 1), jData,
        sparseDataPartBuffer);
   ...
   */
  protected long getSparseBlock(DataFeatureUtils.InternalNumType numType, long vectorIndex,
      long vectorNum, ByteBuffer buf, LongBuffer colIndicesBuf, LongBuffer rowOffsetsBuf) {
    int iVectorIndex = (int) vectorIndex;
    int iVectorNum = (int) vectorNum;
    int sparseBlockSize = (int) (rowOffsets[iVectorIndex + iVectorNum] - rowOffsets[iVectorIndex]);
    ...
    if (numType == DataFeatureUtils.InternalNumType.DAAL_DOUBLE) {
      DataFeatureUtils.VectorUpCastIface vectorUpCast =
          DataFeatureUtils.VectorUpCast.getCast(df.type, DataFeatureUtils.getClassByType(numType));
      vectorUpCast.upCast(sparseBlockSize, (int) (rowOffsets[iVectorIndex] - 1), jData,
          buf.asDoubleBuffer());
  ...
  protected long getDoubleSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
      ByteBuffer colIndicesBuf, ByteBuffer rowOffsetsBuf) {
  ...
  protected long getFloatSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
      ByteBuffer colIndicesBuf, ByteBuffer rowOffsetsBuf) {
    buf.order(ByteOrder.LITTLE_ENDIAN);
    colIndicesBuf.order(ByteOrder.LITTLE_ENDIAN);
    rowOffsetsBuf.order(ByteOrder.LITTLE_ENDIAN);
  ...
  protected long getIntSparseBlock(long vectorIndex, long vectorNum, ByteBuffer buf,
      ByteBuffer colIndicesBuf, ByteBuffer rowOffsetsBuf) {
    buf.order(ByteOrder.LITTLE_ENDIAN);
    colIndicesBuf.order(ByteOrder.LITTLE_ENDIAN);
    rowOffsetsBuf.order(ByteOrder.LITTLE_ENDIAN);
