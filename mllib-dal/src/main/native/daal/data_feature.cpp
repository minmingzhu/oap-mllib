 ...
 * Signature:()Lcom/intel/daal/data_1management/data/DataFeatureUtils/PMMLNumType;
 */
 ...
 * Signature:()Lcom/intel/daal/data_1management/data/DataFeatureUtils/FeatureType;
 */
