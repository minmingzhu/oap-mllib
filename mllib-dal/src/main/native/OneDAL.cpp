...
JNIEXPORT void JNICALL Java_com_intel_oap_mllib_OneDAL_00024_cAddHomogenTable
  (JNIEnv *env, jobject, jlong rowMergedHomogenTableAddr,jlong homogenTableAddr) {
       ...
       mergeTable = new homogen_table(
               mergeData, cRowCount, cColCount, detail::empty_delete<const double>());
}
